...
|---|---|---|
| `POST` | `/chat` | Tirar uma Dúvida — returns `answer`, `sources` (with `excerpt`), `not_found`, `suggested_mode`, `suggested_item_number`, `suggested_book` |
